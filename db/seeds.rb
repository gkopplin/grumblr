...
post_one = Post.create!({post_type: 'text', content: 'Kids these days are so ungrateful. Back in my day, we would have given a whole week of allowance to use a site where you can post using five different mediums!', author_id: user_two.id})
...
post_five = Post.create!({post_type: 'photo', content: 'default', author_id: user_two.id})
wack = open("https://s3.amazonaws.com/grumblr-seeds/wack.jpg")
post_five.media.attach(io: wack, filename: 'wack.jpg')
